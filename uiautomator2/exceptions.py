...
## DHUError (Desktop Head Unit automation, host-side window/process errors)
class DHUError(BaseException): ...
class DHUBinaryNotFoundError(DHUError):...
class DHUNotRunningError(DHUError):...
class DHUImageNotFoundError(DHUError):...